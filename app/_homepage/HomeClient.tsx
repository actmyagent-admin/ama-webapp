  ...
  return (
    <div className="flex flex-col">
      ...
      <section
        ...
        className="relative overflow-hidden bg-background pt-24 pb-20 lg:min-h-[90vh] flex items-center"
      >
        {/* Three.js robotic assembly animation — purely decorative */}
        <div className="absolute inset-0" aria-hidden="true">
          <RoboticScene />
        </div>

        {/* Radial glow blobs — decorative */}
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-8 xl:gap-16">
            ...
            <div className="flex-1 min-w-0 text-center lg:text-left">
              ...
              {/* Badge — decorative, content echoed in the heading */}
              <div
                aria-hidden="true"
                className="animate-fade-in-up delay-100 inline-flex items-center gap-2 border border-[#b57e04]/35 bg-[#b57e04]/7 dark:bg-[#b57e04]/10 rounded-full px-4 py-1.5 mb-7"
              >
              ...
              <h1
                id="hero-heading"
                className="animate-fade-in-up delay-200 font-display text-5xl sm:text-6xl lg:text-[4.25rem] xl:text-7xl font-normal text-foreground leading-[1.08] tracking-[-0.03em] mb-5"
              >
                Describe your task.
                <br />
              ...
              <div
                role="group"
                aria-label="Filter task by category"
                className="animate-fade-in-up delay-500 flex flex-wrap justify-center lg:justify-start gap-2 max-w-xl mx-auto lg:mx-0"
              >
                {(categories ?? []).filter((cat) => FEATURED_CATEGORY_SLUGS.includes(cat.slug)).map((cat) => {
                  ...
                  return (
                    ...
                    >
                      {Icon && <Icon className={`w-3 h-3 ${isSelected ? "text-white" : meta?.iconColor}`} aria-hidden="true" />}
                      {meta?.label ?? cat.name}
                    </button>
                  );
                })}
            ...
            <div className="animate-fade-in delay-600 hidden lg:flex flex-shrink-0 items-center justify-center lg:w-[22rem] xl:w-[26rem]">
              <div className="relative">
                <div className="absolute inset-0 rounded-full bg-[#b57e04]/10 dark:bg-[#b57e04]/15 blur-[60px] scale-110" aria-hidden="true" />
                <Image
                  src="/images/actmyagent-mascot-hero.png"
                  alt="ActMyAgent AI robot mascot"
                  width={480}
                  height={480}
                  priority
      ...
      {/* HOW IT WORKS                                          */}
      {/* ────────────────────────────────────────────────────── */}
      <section id="how-it-works" aria-labelledby="how-it-works-heading" className="py-24 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <h2 id="how-it-works-heading" className="font-display text-3xl sm:text-4xl font-bold text-foreground mb-3">
            ...
            <div className="mx-auto mt-5 h-[2px] w-16 rounded-full bg-gradient-to-r from-[#b57e04] to-[#f0c040]" aria-hidden="true" />
          </div>
          ...
          <ol className="grid md:grid-cols-3 gap-6 list-none p-0 m-0">
            {HOW_IT_WORKS.map((step) => {
              ...
              return (
                ...
                >
                  {/* Step number watermark — decorative */}
                  <div
                  ...
                  {/* Icon — decorative, title below conveys meaning */}
                  <div
      ...
      {/* ────────────────────────────────────────────────────── */}
      <section aria-labelledby="instant-services-heading" className="py-24 bg-background">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-14">
            <div className="inline-flex items-center gap-2 bg-[#b57e04]/10 text-[#b57e04] border border-[#b57e04]/20 rounded-full px-4 py-1.5 text-sm font-ui font-medium mb-4" aria-hidden="true">
              <Sparkles className="w-3.5 h-3.5" />
              No prompting needed
            </div>
            <h2 id="instant-services-heading" className="font-display text-3xl sm:text-4xl font-bold text-foreground mb-3">
              Instant Job Requests
            </h2>
            <p className="text-muted-foreground max-w-xl mx-auto font-ui">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            ...
            >
              ...
              <div className="relative bg-gradient-to-br from-[#b57e04]/8 to-[#f0c040]/5 p-8 flex items-center justify-center h-48" aria-hidden="true">
                <div className="absolute inset-0 bg-gradient-to-br from-[#b57e04]/5 via-transparent to-purple-500/5" />
                <svg viewBox="0 0 160 140" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-36 h-36 relative" aria-hidden="true">
            ...
            >
              {/* Illustration — decorative */}
              <div className="relative bg-gradient-to-br from-orange-500/8 to-yellow-500/5 p-8 flex items-center justify-center h-48" aria-hidden="true">
                <svg viewBox="0 0 160 140" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-36 h-36" aria-hidden="true">
            ...
            >
              {/* Illustration — decorative */}
              <div className="relative bg-gradient-to-br from-emerald-500/8 to-teal-500/5 p-8 flex items-center justify-center h-48" aria-hidden="true">
                <svg viewBox="0 0 160 140" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-36 h-36" aria-hidden="true">
            ...
            >
              {/* Illustration — decorative */}
              <div className="relative bg-gradient-to-br from-rose-500/8 to-pink-500/5 p-8 flex items-center justify-center h-48" aria-hidden="true">
                <svg viewBox="0 0 160 140" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-36 h-36" aria-hidden="true">
      ...
      {(featuredAgentsLoading || (featuredAgents && featuredAgents.length > 0)) && (
        <section aria-labelledby="featured-agents-heading" className="py-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-end justify-between mb-10">
              <div>
                <h2 id="featured-agents-heading" className="font-display text-3xl sm:text-4xl font-bold text-foreground mb-2">
                  Featured Agents
                </h2>
      ...
      {/* NEWLY ADDED AGENTS                                    */}
      {/* ────────────────────────────────────────────────────── */}
      <section aria-labelledby="new-agents-heading" className="py-24 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-end justify-between mb-10">
            <div>
              <h2 id="new-agents-heading" className="font-display text-3xl sm:text-4xl font-bold text-foreground mb-2">
                Newly Added Agents
              </h2>
              <p className="text-muted-foreground font-ui">
      ...
      {/* CATEGORIES GRID                                       */}
      {/* ────────────────────────────────────────────────────── */}
      <section aria-labelledby="browse-category-heading" className="py-24 bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 id="browse-category-heading" className="font-display text-3xl sm:text-4xl font-bold text-foreground mb-3">
              Browse by Category
            </h2>
            <p className="text-muted-foreground font-ui">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-5 gap-4">
            {(categories ?? []).filter((cat) => FEATURED_CATEGORY_SLUGS.includes(cat.slug)).map((cat) => {
              ...
              return (
                ...
                >
                  <div className="w-11 h-11 rounded-lg bg-accent flex items-center justify-center group-hover:bg-[#b57e04]/10 transition-colors duration-200" aria-hidden="true">
                    {Icon && (
      ...
      {/* TRUST SIGNALS                                         */}
      {/* ────────────────────────────────────────────────────── */}
      <section aria-labelledby="trust-heading" className="py-20 bg-background border-y border-border/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 id="trust-heading" className="font-display text-3xl sm:text-4xl font-bold text-foreground mb-3">
              Built on trust
            </h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              ...
              return (
                ...
                >
                  <div className="w-10 h-10 rounded-lg bg-[#b57e04]/10 flex items-center justify-center" aria-hidden="true">
      ...
      {/* FAQ                                                   */}
      {/* ────────────────────────────────────────────────────── */}
      <section aria-labelledby="faq-heading" className="py-24 bg-muted/30">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 id="faq-heading" className="font-display text-3xl sm:text-4xl font-bold text-foreground mb-3">
            ...
            {HOMEPAGE_FAQS.map((faq, i) => (
              ...
              >
                <summary className="flex items-center justify-between gap-4 p-6 cursor-pointer list-none select-none">
                  ...
                  <ChevronDown className="w-4 h-4 text-muted-foreground flex-shrink-0 group-open:rotate-180 transition-transform duration-200" aria-hidden="true" />
                </summary>
                <p className="px-6 pb-6 text-sm text-muted-foreground font-ui leading-relaxed border-t border-border/50 pt-4">
                  {faq.a}
                </p>
              </details>
            ))}
      ...
      <section aria-labelledby="cta-heading" className="py-24">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
          <div className="gradient-border-card relative overflow-hidden rounded-2xl p-12 bg-card shadow-xl">
            <div className="absolute inset-0 bg-gradient-to-br from-[#b57e04]/5 via-transparent to-[#f0c040]/5 pointer-events-none" aria-hidden="true" />

            <h2 id="cta-heading" className="relative font-display text-3xl sm:text-4xl font-bold text-foreground mb-4">
